...
@Data
public class SixthSenseResultResponse implements Serializable {
	...
	private List<SixthSenseSearchResultDTO> searchResults = null;

	@JsonProperty("profileHTML")
	private String profileHTML = null;
	
	@JsonProperty("profileData")
	private String profileData = null;
	
	@JsonProperty("captchaHTML")
